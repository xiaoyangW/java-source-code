        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * 存储ArrayList元素的数组，ArrayList的容量是此数组的长度,添加第一个元素时候如果elementData等于DEFAULTCAPACITY_EMPTY_ELEMENTDATA时空的ArrayList都将扩展为DEFAULT_CAPACITY
     */
    transient Object[] elementData; // non-private to simplify nested class access

    /**
     * ArrayList的大小，List中的元素数量
     *
     * @serial
     */
    private int size;
    ...
    private void ensureCapacityInternal(int minCapacity) {
        //未指定Capacity构建的list默认扩容DEFAULT_CAPACITY
    ...
    /**
     * 将指定元素插入此列表中的指定位置。 
     * 将当前位置的元素（如果有）和任何后续元素向右移动（将其添加到其索引中）。
     *
